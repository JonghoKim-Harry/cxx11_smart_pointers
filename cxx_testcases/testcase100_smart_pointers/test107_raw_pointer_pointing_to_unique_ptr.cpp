...
BOOST_AUTO_TEST_SUITE( test107_raw_pointers_pointing_to_unique_pointers )

BOOST_AUTO_TEST_CASE( test107_01_unique_pointer_as_a_parameter_using_std_move,
                      *boost::unit_test::expected_failures(1) ) {
    BOOST_TEST_MESSAGE("START TEST107-01 raw pointers pointing to unique pointers");
    ...
    BOOST_TEST_MESSAGE("FINISHED TEST107-01");
}

BOOST_AUTO_TEST_CASE( test107_02_raw_pointer_pointing_to_unique_pointer_as_a_parameter ) {
    BOOST_TEST_MESSAGE("START TEST107-02 raw pointers pointing to unique pointer as a parameter");
    ...
    BOOST_TEST_MESSAGE("FINISHED TEST107-02");
}

BOOST_AUTO_TEST_CASE( test107_03_lvalue_reference_pointing_to_unique_pointer_as_a_parameter ) {
    BOOST_TEST_MESSAGE("START TEST107-03 l-value reference_pointing to unique pointer as a parameter");
    ...
    BOOST_TEST_MESSAGE("FINISHED TEST107-03");
}
